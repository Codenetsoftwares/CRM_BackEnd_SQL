...
export const validateAdminCreate = [
  ...
  body("roles")
    ...
    .isArray({ min: 1 })
    .withMessage(
      "Roles must be provided as an array and must contain at least one role"
    ),
];
...
export const validates = [
  param("editId")
    .notEmpty()
    .withMessage("editId is required")
    .isUUID()
...
export const validateMoveToTrash = [
  param("editId")
    ...
    .withMessage("editId is required")
    .isUUID(4)
    .withMessage("editId must be a valid ID"),
];
...
export const validateWebsiteName = [
  body("website_name").isArray().withMessage("Website name must be an array"),
];
...
export const validateIntroducerUsername = [
  param("introducerUsername")
    .notEmpty()
    .withMessage("introducerUsername is required"),
  query("page")
    .optional()
    .isInt({ min: 1 })
    .withMessage("Page must be an integer greater than or equal to 1"),
